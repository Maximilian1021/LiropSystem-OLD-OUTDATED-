...
public class Titan implements CommandExecutor 
{
	...
	public Titan(LiropSystem liropSystem) {
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
	      ...
	      sender.sendMessage("§7§m                      §C§l Titan Rang §7§m                     ");
	      sender.sendMessage("§9Kosten §3 --> §a15 Euro");
	      sender.sendMessage("");
	      sender.sendMessage("§9Hier Kaufbar §3 --> §ahttp://lirop.net/spenden");
	      sender.sendMessage("§9Zahlbar via §3--> §aPayPal & PaySafeCard");										//Titan Vorteile
	      sender.sendMessage("");
