...
public class Ultimate implements CommandExecutor
{

	public Ultimate(LiropSystem liropSystem) {
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) 
	{
	     ...
	     sender.sendMessage("§7§m                      §C§l Ultimate Rang §7§m                     ");;
	     sender.sendMessage("§9Kosten §3 --> §a50 Euro");
	     sender.sendMessage("");
	     sender.sendMessage("§9Hier Kaufbar §3 --> §ahttp://lirop.net/spenden");
	     sender.sendMessage("§9Zahlbar via §3--> §aPayPal & PaySafeCard");									//Ultimate Vorteile
	     sender.sendMessage("");
